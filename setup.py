...
setup(
    name='firsttest',
    version='',
    packages=['SNS.twitter', 'venv.Lib.site-packages.bs4', 'venv.Lib.site-packages.bs4.tests',
              'venv.Lib.site-packages.bs4.builder', 'venv.Lib.site-packages.idna', 'venv.Lib.site-packages.certifi',
              ...
              'venv.Lib.site-packages.urllib3.packages.ssl_match_hostname', 'venv.Lib.site-packages.oauthlib',
              ...
              'venv.Lib.site-packages.pip-9.0.1-py3.6.egg.pip.operations', 'boxes', 'boxes.soruces'],
    url='',
    license='',
    author='GOTO',
    author_email='',
